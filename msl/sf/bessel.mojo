...
def bessel_Y1(x: Float64) -> SFSResult:
    ...
    if y < 2.0 * MSL_SQRT_DBL_EPSILON:
        ...
        comptime bm1_c: Array[Float64, 21] = [
            0.1170304509391578,
            -0.0021846037119180,
            0.0000644125585904,
            -0.0000051198594778,
        ...
        var ca = cheb_eval(materialize[bm1_c](), 20, -1.0, 1.0, z)

        comptime bth1_c: Array[Float64, 24] = [
            0.74060141026313850,
            -0.004571755659637690,
            0.000119818510964326,
            -0.000006964561891648,
        ...
        var ct = cheb_eval(materialize[bth1_c](), 23, -1.0, 1.0, z)
