...
comptime _xgk: Array[Float64, 16] = [
...
comptime _wgk: Array[Float64, 16] = [
...
def qk31[
    ...
    var fv1 = Array[Float64, 16](uninitialized=True)
    var fv2 = Array[Float64, 16](uninitialized=True)
    ref _xgk_vals = materialize[_xgk]()
    ref _wg_vals = materialize[_wg]()
    ref _wgk_vals = materialize[_wgk]()
    return _qk_generic[fn_](16, _xgk_vals, _wg_vals, _wgk_vals, fv1, fv2, a, b)
